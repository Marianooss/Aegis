...
|---|---|---|
| `clinical_note` | `string` | Full source clinical note (ground truth) |
| `ai_summary` | `string` | AI-generated summary to validate |
| `patient_id` | `string` | Optional patient identifier |
| `summary_model` | `string` | Optional model identifier |
| `escalation_threshold` | `LOW \| MEDIUM \| HIGH` | Reserved — current escalation uses fixed severity matrix (ADR-008) |
